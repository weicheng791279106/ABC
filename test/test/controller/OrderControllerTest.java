...
public class OrderControllerTest {
	...
	public void getOrderByIdTest() throws Exception{
		ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.get("/order/getOrderById")
				.param("id", "2")
	...
	@org.junit.Test
	public void getUserOrderQueryVoListTest() throws Exception{
		ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.get("/order/getUserOrderQueryVoList")
				.accept(MediaType.APPLICATION_JSON));
		MvcResult mvcResult = resultActions.andReturn();
		String result = mvcResult.getResponse().getContentAsString();
		System.out.println("\n\n\n" + result + "\n\n\n");
